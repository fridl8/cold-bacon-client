...
export default class GameStartFetch extends Component {
	...
	render() {
		...
		return (
			<View>
				<View>
					<ActorImage text={{uri: 'https://image.tmdb.org/t/p/w185/'+this.state.actors.starting_actor.image_url}} onPress={() => navigate('StartingActorsMovies', { id: this.state.actors.game_id} )} />
				</View>
				<View>
