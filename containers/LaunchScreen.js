  ...
  render() {
    const { navigate } = this.props.navigation;
      ...
      <Image source={require('../assets/images/cold-kevin.jpg')} style={styles.kevin} >
        ...
        <View>
          <StartButton text=' ' textStyle={buttonStyles.generalButtonText} touchStyle={buttonStyles.demoButton} onPress={() => navigate('GameStart', { create_game_path: '/create_demo/'+startingActorTmdb+'/'+endingActorTmdb } ) } />
        </View>
      </Image>
    </View>
		);
